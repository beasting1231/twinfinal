    ...
    <header data-history-ignore="true" className="bg-white dark:bg-zinc-950 border-b border-gray-200 dark:border-zinc-800 pt-[env(safe-area-inset-top)]">
      <div className="flex items-center justify-between p-4">
        ...
        <Sheet open={sheetOpen} onOpenChange={setSheetOpen}>
          ...
          <SheetContent side="left" className="w-72 overflow-y-auto border-gray-200 bg-white pt-[calc(env(safe-area-inset-top)+1rem)] dark:border-zinc-700 dark:bg-zinc-900">
            <SheetHeader>
            ...
            <div className="flex flex-col gap-2 mt-6">
              ...
              {role === "admin" && (
                <button
                  ...
                  className={`w-full rounded-lg px-4 py-3 text-left text-gray-900 transition-colors hover:bg-gray-100 dark:text-white dark:hover:bg-zinc-800 ${
                    isActive("/analytics") ? "bg-gray-100 dark:bg-zinc-800" : ""
                  }`}
                >
                  Analytics
                </button>
              ...
              {permissions.canManageDriversAndSources && role !== "admin" && (
                <button
              ...
              {permissions.canManageBookingRequests && role !== "admin" && (
                <button
              ...
              {permissions.canManageNotifications && role !== "admin" && (
                <button
              ...
              {role === "admin" && (
                <div>
                  <button
                    ...
                    className="flex w-full items-center justify-between rounded-lg px-4 py-3 text-left text-gray-900 transition-colors hover:bg-gray-100 dark:text-white dark:hover:bg-zinc-800"
                  >
                    <span>More</span>
                    <ChevronRight
                      className={`h-4 w-4 text-gray-500 transition-transform duration-200 dark:text-zinc-400 ${
                        moreOpen ? "rotate-90" : ""
                      }`}
                    />
                  </button>
                  {moreOpen && (
                    <div
                      id="admin-more-menu"
                      className="ml-4 mt-1 flex flex-col gap-1 border-l border-gray-200 pl-3 dark:border-zinc-700"
                    >
                      {[
                        ["Priority", "/priority"],
                        ...
                        <button
                          ...
                          className={`w-full rounded-lg px-3 py-2.5 text-left text-sm text-gray-900 transition-colors hover:bg-gray-100 dark:text-white dark:hover:bg-zinc-800 ${
                            isActive(path) ? "bg-gray-100 font-medium dark:bg-zinc-800" : ""
                          }`}
                        >
                          {label}
                        </button>
              ...
              {role !== "agency" && role !== "admin" && (
                <>
                  ...
                  <a
                    ...
                    className="flex w-full items-center gap-3 rounded-lg bg-green-600 px-4 py-3 font-medium text-white transition-colors hover:bg-green-700"
                  >
